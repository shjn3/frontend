...
`;let a=document.querySelector("#ca");const u=document.querySelector("#btn_send"),g=document.querySelector("#console");function x(e){console.log("set value"),g&&(console.log("set value1"),g.value==e)}u==null||u.addEventListener("click",async()=>{const e=(a==null?void 0:a.value)||"";if(e===""){x("");return}const t=await L(e),n=t.pairs==null||t.pairs==null?null:t.pairs.length>0?t.pairs[0]:null;let r=[];n!=null?r=[{name:"Dexscreener",value:`https://dexscreener.com/solana/${e}`}]:r=[...r,{name:"Pumpfun",value:`https://pump.fun/${e}`}];const o={name:i((n==null?void 0:n.baseToken.name)||""),symbol:i((n==null?void 0:n.baseToken.symbol)||""),ca:(a==null?void 0:a.value)||"",sol_trading_bot:`https://t.me/SolTradingBot?start=${e}-DRDAzntWc`,trojan_bot:`https://t.me/solana_trojanbot?start=r-shj_n3-${e}`,meta_bot:"https://t.me/MetaSolanaBot?start=ESGFYCYF",gmgn_bot:`https://t.me/GMGN_sol_bot?start=i_3gO5u7fq_c_${e}`,caller_twitter_url:"https://x\\.com/lorecarbia",caller_telegram_url:"https://t\\.me/callerjerry",channel_url:"https://t\\.me/jerrysgamble",scan:T(r),description:M(n),info:S(n)},s=b(o);m.send_message(s.telegram),m.send_message(s.x)});h(document.querySelector("#counter"));
